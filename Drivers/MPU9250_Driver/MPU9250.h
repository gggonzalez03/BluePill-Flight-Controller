...
#ifndef MPU9250_DRIVER_MPU9250_H_
#define MPU9250_DRIVER_MPU9250_H_

#include <math.h>
#include "mpu_porting_api.h"

#define wait				MPU_delay_s
#define delay				MPU_delay_ms
...
HAL_StatusTypeDef writeByte(uint8_t address, uint8_t subAddress, uint8_t data)
{
		...
		data_tx_ret = HAL_I2C_Mem_Write(&hi2c1, (uint16_t)address, (uint16_t)subAddress, 1, &data, 1, 10);
...
char readByte(uint8_t address, uint8_t subAddress)
{
    char data[1]; // `data` will store the register data
  	...
  	data_rx_ret = HAL_I2C_Mem_Read(&hi2c1, (uint16_t)address, (uint16_t)subAddress, 1, (uint8_t*)data, 1, 10);
...
void readBytes(uint8_t address, uint8_t subAddress, uint8_t count, uint8_t * dest)
{
		...
		data_rx_ret = HAL_I2C_Mem_Read(&hi2c1, (uint16_t)address, (uint16_t)subAddress, 1, dest, (uint16_t)count, 10);
...
#endif /* MPU9250_DRIVER_MPU9250_H_ */
